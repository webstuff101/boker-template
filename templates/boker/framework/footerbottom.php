<?php
/**
 * Boker Template Framework - Footer Bottom Section
 * 
 * @package     Joomla.Site
...
// Columns layout
$footerbottom_four_columns_layout = $this->params->get('footerbottom_four_columns_layout', '3,3,3,3');
$footerbottom_three_columns_layout = $this->params->get('footerbottom_three_columns_layout', '4,4,4');
$footerbottom_two_columns_layout = $this->params->get('footerbottom_two_columns_layout', '6,6');

// Helper function to determine grid classes for 4 columns
function getFooterBottomGrid4Col($layout, $position)
{
	$layouts = [
...
function getFooterBottomGrid3Col($layout, $position)
{
	$layouts = [
...
function getFooterBottomGrid2Col($layout, $position)
{
	$layouts = [
		'2,10' => ['grid_2', 'grid_10'],
		'3,9' => ['grid_3', 'grid_9'],
...
$grid_4col_1 = getFooterBottomGrid4Col($footerbottom_four_columns_layout, 0);
$grid_4col_2 = getFooterBottomGrid4Col($footerbottom_four_columns_layout, 1);
$grid_4col_3 = getFooterBottomGrid4Col($footerbottom_four_columns_layout, 2);
$grid_4col_4 = getFooterBottomGrid4Col($footerbottom_four_columns_layout, 3);

$grid_3col_1 = getFooterBottomGrid3Col($footerbottom_three_columns_layout, 0);
$grid_3col_2 = getFooterBottomGrid3Col($footerbottom_three_columns_layout, 1);
$grid_3col_3 = getFooterBottomGrid3Col($footerbottom_three_columns_layout, 2);

$grid_2col_1 = getFooterBottomGrid2Col($footerbottom_two_columns_layout, 0);
$grid_2col_2 = getFooterBottomGrid2Col($footerbottom_two_columns_layout, 1);
